...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-lg hover:shadow-primary/25 hover:bg-primary/90 hover:-translate-y-0.5",
        destructive:
        ...
        glow: "bg-primary text-primary-foreground shadow-[0_0_20px_rgba(116,57,255,0.5)] hover:shadow-[0_0_30px_rgba(116,57,255,0.7)] hover:scale-105 border border-primary/50",
      },
      size: {
